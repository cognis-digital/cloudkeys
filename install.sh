#!/usr/bin/env sh
# Universal installer for cloudkeys. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cloudkeys.git"
echo "Installing cloudkeys ..."
